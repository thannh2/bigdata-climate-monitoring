...
def get_l0_weather_schema() -> StructType:
    """Schema chuẩn xác từ NormalizedWeatherRecord của hệ thống Ingestion"""
    return StructType([
...
def get_l0_unified_schema() -> StructType:
    """Schema hợp nhất cho cả Weather và Air Quality"""
    return StructType([
        StructField("event_id", StringType(), True),
        StructField("source", StringType(), True),
        StructField("region", StringType(), True),
...
def get_weather_schema() -> StructType:
    """Schema dành riêng cho luồng dữ liệu Thời tiết (Weather)"""
    return StructType([
        StructField("event_id", StringType(), True),
        StructField("source", StringType(), True),
        StructField("region", StringType(), True),
...
def get_air_schema() -> StructType:
    """Schema dành riêng cho luồng dữ liệu Chất lượng Không khí (Air Quality)"""
    return StructType([
        StructField("event_id", StringType(), True),
        StructField("source", StringType(), True),
        StructField("region", StringType(), True),
